...
<html lang="en">
  ...
  <body class="bg-[#fff8f0] font-poppins">
    ...
    <!-- Isi Manajemen Booking -->
    <div class="main--content transition-all duration-500 ease-in-out ml-[116px] lg:ml-[240px] p-8">
    <div class="header--wrapper mb-1">
        <div class="header--title">
            <h2 class="text-3xl font-semibold">Manajemen Booking</h2> 
        </div>
    </div>
    <!-- Booking Table -->
    <table class="booking-table w-full table-auto border-separate border-spacing-0 shadow-md rounded-lg overflow-hidden">
    <thead class="bg-gray-200">
        <tr>
            ...
            <th class="px-5 py-3 text-left text-sm font-semibold text-gray-600">Tanggal Booking</th>
    ...
    <tbody>
        <tr class="border-b border-gray-200">
            ...
            <td class="px-5 py-3 text-sm text-gray-800">
                <span class="px-3 py-1 text-xs font-semibold text-white bg-green-500 rounded-full">Confirmed</span>
            </td>
        </tr>
    </tbody>
    <tbody>
        <tr class="border-b border-gray-200">
            <td class="px-5 py-3 text-sm font-medium text-gray-800">3</td>
            <td class="px-5 py-3 text-sm text-gray-800">Jayagiri</td>
