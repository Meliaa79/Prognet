...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="../css/DaftarFavorite.css" />
    ...
    <table class="favorite-table w-full table-auto border-separate border-spacing-0 shadow-md rounded-lg overflow-hidden">
        <thead class="bg-gray-200">
            <tr>
                ...
                <th class="px-5 py-3 text-left text-sm font-semibold text-gray-600">Alamat</th>
                <th class="px-5 py-3 text-left text-sm font-semibold text-gray-600">Tanggal Simpan</th>
            </tr>
        </thead>
        <tbody>
            <tr class="border-b border-gray-200">
                ...
                <td class="px-5 py-3 text-sm text-gray-800">Jl. Suli No.69, Kota Denpasar</td>
        ...
        <tbody>
            <tr class="border-b border-gray-200">
                ...
                <td class="px-5 py-3 text-sm text-gray-800">Jl. Jaya Giri Utama Ruko Kapling No.A6, Denpasar Selatan, Kota Denpasar</td>
