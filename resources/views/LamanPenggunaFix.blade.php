...
<body class="bg-[#fff8f0] font-poppins">
    ...
    <aside class="sidebar fixed top-0 left-0 bottom-0 w-[116px] h-screen p-[1.7rem] bg-[#734424] text-[#fff8f0] transition-all duration-500 ease-in-out lg:w-[240px] hover:w-[240px]">
        ...
        <ul class="menu h-[88%] relative space-y-4">
            ...
            <li class="hover:bg-[#814e2b] rounded-lg">
                <a href="../views/RiwayatReview.blade.php" class="flex items-center space-x-3 text-sm">
    ...
    <div class="main-content transition-all duration-500 ease-in-out ml-[116px] lg:ml-[240px] p-8">
        <div class="header-wrapper mb-8">
            <div id="welcomeMessage" class="header-title text-primary">
                <h2 class="text-3xl font-semibold">Welcome, Jihoon-!!</h2>
                <p class="text-lg text-focus">Manage your account details and settings here</p>
            </div>
        </div>

        <div id="userProfile" class="user-profile-view bg-white p-8 rounded-xl shadow-lg mb-8 flex flex-col md:flex-row gap-8">
            <div class="user-property flex justify-center md:justify-start mt-20">
                <img src="../img/vintage icon.jpeg" alt="Profile Picture" class="w-48 h-48 rounded-full shadow-lg"/>
            </div>
            <div class="user-detail flex flex-col gap-4 w-full md:w-3/4">
                <div class="detail-grid flex flex-col gap-4 px-2">
                    <div class="detail-item bg-gray-100 p-4 rounded-md shadow-sm">
                        ...
                        <span id="displayName" class="break-words">Park Jihoon</span>
                    </div>
                    <div class="detail-item bg-gray-100 p-4 rounded-md shadow-sm">
                        <strong class="text-primary">Username:</strong>
                        <span id="displayUsername" class="break-words">@jihoon</span>
                    </div>
                    <div class="detail-item bg-gray-100 p-4 rounded-md shadow-sm">
                        <strong class="text-primary">Email:</strong>
                        <span id="displayEmail" class="break-words">jihoon@gmail.com</span>
                    </div>
                    <div class="detail-item bg-gray-100 p-4 rounded-md shadow-sm">
                        <strong class="text-primary">Phone Number:</strong>
                        <span id="displayPhone" class="break-words">082347567893222</span>
                    </div>
    ...
    <div id="editProfileForm" class="user-profile-edit hidden flex justify-between items-center bg-white p-8 rounded-xl shadow-lg mb-8 gap-8 mt-8">
        <form id="updateForm" class="detail-grid grid grid-cols-1 gap-8" onsubmit="showConfirmation(event)">
            <div class="detail-item flex justify-between items-center">
                <label class="text-[#734424] font-medium"><strong>Full Name:</strong></label>
                <input type="text" name="fullName" id="editFullName" value="Park Jihoon" class="border border-gray-300 rounded px-4 py-2" required />
            </div>
    ...
    <script>
        ...
        function cancelEditAction() {
            ...
            document.getElementById('userProfile').style.display = 'flex';  // Tampilkan profil
        ...
        function saveProfile() {
            ...
            document.getElementById('userProfile').style.display = 'flex';  // Menampilkan profil
